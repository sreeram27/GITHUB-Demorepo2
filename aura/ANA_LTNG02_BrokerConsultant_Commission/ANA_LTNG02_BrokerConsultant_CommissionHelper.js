({
    ...
    callServer : function(component, event, helper) {  
       ...
       //get Related Consultant Values
        this.getBCOptions(component, component.get("v.accId"));
        
        //get Account Lookup defualt value
        var AccParam = {
            objectName:'Account',
            fld_API_Text: 'Name',
            fld_API_Val:'Id',
            lim:'1',
            fld_API_Search:'Id',
            searchText: component.get("v.accId"),
            searchSpecific : ''}; // '0014B00000KN5IBQA1'
       this.getDefaultLookup(component,AccParam,'Account');
    ...
    getBCOptions: function(component,acId) {		   
    ...
    saveBrokerandConsult : function(component, event, helper) {
     ...
     setFundingType: function(component) {
			...
			var BrkParam = {
			objectName:'Brokerage_and_Consultant__c',
			fld_API_Text: 'Name',
			fld_API_Val:'Id',
			lim:'1',
			fld_API_Search:'Id',
    ...
    handleResponse : function (res,component,type){        
        if (res.getState() === 'SUCCESS') {            
            ...
            if(type != 'SaveBC'){
                ...
                console.log("Displaying retObj" + retObj + 'Type: '+type)
                if(retObj.length > 0){            
                    if(type == 'Account'){                    
    ...
    saveRecordBR: function(component, event, helper)
    {
					...
					var Account_lookup = 	component.find("Account_lookup");
